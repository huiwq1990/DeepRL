...
java -ea -Xmx128M -jar  $systemPath/common/libs/rl-viz/RLVizApp.jar list-agents=false list-environments=true env-viz=true agent-viz=true agent-environment-jar-path=$productsPath
